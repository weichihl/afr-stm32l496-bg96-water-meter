...
#define USE_MODEM_VOUCHER             0  /* 0: voucher management not included - 1: voucher management included */
...
#define USE_TRACE_CUSTOM_CLIENT       (0U)
#endif /* !defined USE_TRACE_CUSTOM_CLIENT */
#define USE_TRACE_ECHO_CLIENT         (0U)
#define USE_TRACE_HTTP_CLIENT         (0U)
#define USE_TRACE_PING_CLIENT         (0U)
#define USE_TRACE_COM_CLIENT          (0U)
#define USE_TRACE_MQTT_CLIENT         (0U)
...
#define USE_TRACE_CELLULAR_MNGT       (0U)
